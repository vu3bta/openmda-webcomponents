    ...
    <script lang="ts">
      export type {AlertType} from '@vu3bta/openbridge-webcomponents/dist/types';
    </script>
    <script setup lang="ts">
      import { h, useSlots, reactive } from "vue";
      import { assignSlotNodes, Slots } from "@lit-labs/vue-utils/wrapper-utils.js";
      import '@vu3bta/openbridge-webcomponents/dist/components/alert-topbar-element/alert-topbar-element.js';
      import {AlertType} from '@vu3bta/openbridge-webcomponents/dist/types';
