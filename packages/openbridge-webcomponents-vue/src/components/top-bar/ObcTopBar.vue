    ...
    <script lang="ts">
      export type {BreadcrumbItem} from '@vu3bta/openbridge-webcomponents/dist/components/breadcrumb/breadcrumb';
    </script>
    <script setup lang="ts">
      import { h, useSlots, reactive } from "vue";
      import { assignSlotNodes, Slots } from "@lit-labs/vue-utils/wrapper-utils.js";
      import '@vu3bta/openbridge-webcomponents/dist/components/top-bar/top-bar.js';
      import {BreadcrumbItem} from '@vu3bta/openbridge-webcomponents/dist/components/breadcrumb/breadcrumb';
